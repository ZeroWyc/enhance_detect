...
parser.add_argument('--weights', default='./pretrain_model/LOL_v2_real.pth', type=str, help='Path to weights')

parser.add_argument('--dataset', default='LOLv2_real', type=str,
                    help='Test Dataset')
